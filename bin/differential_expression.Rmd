...
gtf <- rtracklayer::import("../input/annotation/gencode.vM21.annotation.gtf")


paste(setdiff(as.character(samples$SampleID), as.character(samples[which(samples$Condition == "overexpression" & samples$CellType == "mESCs" & (samples$Timepoint == 0 | samples$Timepoint == 60 | samples$Timepoint == 90 | samples$Timepoint == 120 | samples$Timepoint ==30)), "SampleID"])), collapse = "* ")
